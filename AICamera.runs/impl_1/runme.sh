...
HD_PWD='D:/GitHub/AICamera/AICamera/AICamera.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log AICameraTop.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source AICameraTop.tcl -notrace
