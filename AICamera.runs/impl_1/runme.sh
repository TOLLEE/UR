...
HD_PWD='D:/Program/Vivido/AICamera/AICamera.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log AICamera.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source AICamera.tcl -notrace
