...
HD_PWD='D:/Program/Vivido/AICamera/AICamera.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AICamera.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AICamera.tcl
