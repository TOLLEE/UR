...
HD_PWD='D:/GitHub/AICamera/AICamera/AICamera.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AICameraTop.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AICameraTop.tcl
